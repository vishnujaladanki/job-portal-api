...
func TestNewService_ApplyJob(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "failing budget if conditions",
			args: args{
				application: []models.JobApplication{
					{
						Name:            "vishnu",
			...
			want:    []models.Applicant{{Name: "vishnu", Email: "vishnu@gmail.com", Age: 24}},
			wantErr: false,
			mockResponse: func() (models.Job, error) {
				return models.Job{
					ID:              1,
		...
		{
			name: "failing noticeperiod if conditions",
			args: args{
				application: []models.JobApplication{
					{
						Name:            "vishnu",
		...
		{
			name: "failing experience if conditions",
			args: args{
				application: []models.JobApplication{
					{
						Name:            "vishnu",
